	...
	<main class="chkout">
        <div class="bread-wrap">
            <div class="container">
                <ul class="bread justify-content-start list-unstyled">
                    <li><a href="{{ asset('/') }}" title="">{{ trans('lang.title12') }}</a></li>
                    <li><a href="{{ asset('gio-hang') }}" title="">{{ trans('lang.title3') }}</a></li>
        ...
        @if (Cart::count() > 0)
	        <div class="container t5">
	            <h1 class="medium s24 chk-tit">Thanh toán</h1>
	                    ...
	                    <div class="chk-item chkout-bfrm">
	                        ...
	                        <div class="chkout-frm">
	                            <div class="form-group">
									...
									<input type="text" name="name" class="form-control form-field" placeholder="Họ tên người nhận hàng" required="required" 
										value="{!! old('name', isset($custommer) ? $custommer->name : null) !!} ">
	                            </div>
	                            <div class="form-group">
	                                <label class="form-label">Số điện thoại</label>
									<input type="number" name="phone" class="form-control form-field" placeholder="Số điện thoại liên hệ khi nhận hàng" required="required" 
										value="{!! old('phone', isset($custommer) ? $custommer->phone : null) !!}">
	                            </div>
	                            <div class="form-group">
	                                <label class="form-label">Email</label>
									<input type="email" name="email" class="form-control form-field" placeholder="Email" required="required" 
