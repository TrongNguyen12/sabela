                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                              ...
                              <option value="size_category">Size</option>
                              <option value="material_category">Chất liệu</option>
                              <option value="season_category">Theo mùa</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Tiêu đề</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nameeg" value="{!! old('nameeg') !!}">
                        </div>
                        <div class="form-group">
