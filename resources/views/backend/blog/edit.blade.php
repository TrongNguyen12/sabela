            ...
            <div class="tab-content">
                <div class="tab-pane active" id="activity">
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <select name="idCatPost" class="form-control">
                                  <option value="">Chọn danh mục bài viết</option>
                                  @foreach ($catPost as $item)
                                    <option value="{{ $item->id }}" {{ $data['parent_id'] == $item->id ? 'selected' : null }}>{{ $item->name }}</option>
                                  @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="desc" name="content_short">
                        {!! old('content_short', isset($data) ? $data['content_short'] : null) !!}
                      </textarea>
                    </div>
